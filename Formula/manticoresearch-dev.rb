...
class ManticoresearchDev < Formula
  ...
  depends_on "unixodbc"
  depends_on "zstd"
  depends_on "manticoresoftware/manticore-no-bottles/manticore-backup-dev" => :recommended
  depends_on "manticoresoftware/manticore-no-bottles/manticore-buddy-dev" => :recommended
  depends_on "manticoresoftware/manticore-no-bottles/manticore-icudata-dev" => :recommended
